...
export const blogData = [
  ...
  },
  {
    ...
    description:
      "تمثل رخصة القيادة حرية واستقلالية مهمة للنساء في المملكة العربية السعودية بعد إلغاء الحظر على قيادة المرأة في عام 2018. ومع ذلك، هناك إجراءات محددة يجب على النساء اتباعها للحصول على رخصة القيادة. دعونا نلقي نظرة على كيفية حجز موعد ",
