          ...
          <article>
            ...
            <div id='1. قلعة المصمك: رمز الصمود (منطقة ديرة)' className='py-4'>
              ...
              <ul className='list-disc'>
                ...
                <li className='arabic-li'><span className='font-bold'>كيفية الوصول الى هناك:</span>سيارات الأجرة أو خدمات مشاركة الركوب أو الحافلات العامة</li>

                <li className='arabic-li'><span className='font-bold'>نطاق سعر الفندق:</span>تبدأ الأسعار المناسبة للميزانية من حوالي 50 دولارًا في الليلة، بينما تتراوح أسعار الفنادق الفاخرة من 200 دولار فما فوق.</li>
            ...
            <div id='2. المتحف الوطني السعودي: رحلة عبر الزمن (حي البطحاء)'>
              ...
              <ul className='list-disc'>
                ...
                <li className='arabic-li'><span className='font-bold'>كيفية الوصول الى هناك:</span>المترو أو سيارات الأجرة أو خدمات مشاركة الركوب أو الحافلات العامة</li>

                <li className='arabic-li'><span className='font-bold'>نطاق سعر الفندق:</span>كما هو الحال في قلعة المصمك، تتراوح خيارات أماكن الإقامة من الصديقة للميزانية إلى الفاخرة، والتي تلبي تفضيلات المسافرين المختلفة.</li>
            ...
            <div id="3. مركز المملكة: أيقونة مرتفعة (حي الماليزية)" className='py-12'>
              ...
              <ul className='list-disc'>
                ...
                <li className='arabic-li'><span className='font-bold'>نطاق سعر الفندق:</span>يضم مركز المملكة نفسه فندقًا فاخرًا، وهو فندق فورسيزونز الرياض في مركز المملكة، بأسعار تتراوح من 400 دولار وما فوق في الليلة الواحدة. الفنادق الأخرى في المنطقة المجاورة تلبي الميزانيات المختلفة.</li>
            ...
            <div id="4. قصر المربع: لمحة عن التاريخ الملكي (حي المربع)">
              ...
              <ul className='list-disc'>
                ...
                <li className='arabic-li'><span className='font-bold'>نطاق سعر الفندق:</span>توفر منطقة المربع مجموعة متنوعة من الفنادق التي تلبي مختلف الميزانيات والتفضيلات.</li>
            ...
            <div id="5. حافة العالم (جرف طويق)">
              ...
              <ul className='list-disc'>
                ...
                <li className='arabic-li'><span className='font-bold'>كيفية الوصول الى هناك:</span>يعد الانضمام إلى جولة إرشادية هو الخيار الأكثر ملاءمة وأمانًا، حيث يتطلب الوصول إلى الموقع القيادة على الطرق الوعرة.</li>

                <li className='arabic-li'><span className='font-bold'>نطاق سعر الفندق:</span>تعد الرحلات اليومية أمرًا شائعًا في هذا الموقع، لذا لن تكون توصيات الفنادق قابلة للتطبيق. ومع ذلك، توفر الرياض خيارات إقامة متنوعة لإقامتك الشاملة.</li>
            ...
            <div id='نصائح سفر:'>
              ...
              <ul className="list-disc">
                <li className='arabic-li'>أفضل وقت لزيارة الرياض هو خلال الأشهر الباردة، من نوفمبر إلى مارس، عندما تكون درجات الحرارة أكثر راحة للاستكشاف.</li>
                <li className='arabic-li'>في حين أن اللغة العربية هي اللغة الرسمية، إلا أن اللغة الإنجليزية يتم التحدث بها على نطاق واسع في المناطق السياحية.</li>
                <li className='arabic-li'>يوصى بارتداء ملابس محتشمة، خاصة عند زيارة المواقع الدينية.</li>
                <li className='arabic-li'>فكر في شراء بطاقة الرياض للدخول بسعر مخفض إلى العديد من المعالم السياحية ووسائل النقل العام المجانية.</li>
              </ul>
            </div>
