...
export const metadata: Metadata = {
  title: "الكشف عن التميز: الدليل النهائي لأفضل شفاطات المطبخ | Blog Source",
  description: "اكتشف قمة أناقة وتهوية المطبخ من خلال دليلنا الشامل لأفضل شفاطات المطبخ. بدءًا من التصميمات الأنيقة وحتى الأداء القوي، اكتشف الخيارات الأعلى تقييمًا ومراجعات الخبراء ونصائح من الداخل لرفع مستوى مساحة الطهي الخاصة بك. دعنا نرشدك إلى شفاط المطبخ المثالي لمنزلك. الغوص في مدونتنا اليوم!",
};
const KitchenHoods = () => {
  const tableContents = [
