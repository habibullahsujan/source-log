...
export const metadata: Metadata = {
  title: "غزو المطبخ بالوضوح: دليلك الشامل لأغطية المحركات",
  description: "شفاطات المطبخ هي الأبطال المجهولون في معارك الطهي. هؤلاء الحراس الصامتون، الذين يحومون فوق موقدك، يتعاملون مع الدخان والشحوم والروائح المنبعثة أثناء الطهي، مما يحافظ على مطبخك طازجًا وصحة رئتيك. ولكن مع وجود عدد كبير من الخيارات المتاحة، فإن اختيار غطاء المحرك المناسب يمكن أن يبدو وكأنه التنقل في متاهة. لا تخافوا يا عشاق الطعام! سيزودك هذا الدليل الشامل بالمعرفة اللازمة لاختيار شفاط المطبخ المثالي، وتحويل مساحة الطهي الخاصة بك إلى ملاذ للإبداع في الطهي.",
};
const KitchenHoods = () => {
  const tableContents = [
