...
export const metadata: Metadata = {
  title: 'كيفية حجز موعد رخصة القيادة للرجال والنساء في السعودية',
      ...
      <BlogContainer className='mx-2 md:mx-16 py-32 arabic-content-container'>
        ...
        <div className='grid grid-cols-12 gap-x-5'>
          ...
          <div className='col-span-12 lg:col-span-8 text-right'>
            <h1 className='font-bold text-4xl text-[#00563B]'>كيفية حجز موعد للحصول على رخصة القيادة للرجال والنساء في المملكة العربية السعودية: الأنظمة والرسوم وإجراءات التقديم.</h1>
