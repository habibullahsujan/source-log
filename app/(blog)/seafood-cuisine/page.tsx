...
export const metadata: Metadata = {
    title: "مطبخ المأكولات البحرية: استكشاف الطهي لعجائب تحت الماء | Blog Source",
    description: "استمتع بتجربة طعم المد والجزر من خلال مدونتنا المخصصة للمأكولات البحرية الشهية. من الإسكالوب الرقيق إلى حساء الشودر اللذيذ، انضم إلينا في رحلة طهي عبر أعماق النكهة. اكتشف الوصفات وتقنيات الطبخ ووجهات المأكولات البحرية التي ستثير ذوقك",
};
